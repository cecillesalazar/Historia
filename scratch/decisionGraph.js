...
/*
storyNode is as follows
{
  key: ''         //the key of the story
  options: [ ]   // the available other story object this node can transition
  story: ''     // the long text of this story
}
*/
//console.log(STORY_GRAPH[ STORY_GRAPH[SERG_ARRIVES].options[0] ])
...
const getStoryNode = (storyKey) => STORY_GRAPH[storyKey];

let current = getStoryNode(FIRST_WISH)
console.log('current', current)

let selectOption = (i) => getStoryNode(current.options[i]);

current = selectOption(1);

console.log('current after selecting 1', current)
